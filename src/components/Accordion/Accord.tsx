          ...
          <div className="mt-8 flex flex-col gap-4">
            <div className="collapse collapse-arrow bg-[#ffffff0d] rounded-[10px]">
              ...
              <div className="collapse-content text-customGray-main font-[400]">
                <p>
                StableOx is a platform designed to address common issues
            ...
            <div className="collapse collapse-arrow bg-[#ffffff0d] rounded-[10px]">
              ...
              <div className="collapse-title text-xl font-medium text-white">
                How does StableOx ensure the security of my funds?
              </div>
              <div className="collapse-content text-customGray-main font-[400]">
                <p>
            ...
            <div className="collapse collapse-arrow bg-[#ffffff0d] rounded-[10px]">
              ...
              <div className="collapse-content text-customGray-main font-[400]">
                <p>
                  StableOx is designed to be governed by the community.
            ...
            <div className="collapse collapse-arrow bg-[#ffffff0d] rounded-[10px]">
              <input type="radio" name="my-accordion-2" />
              <div className="collapse-title text-xl font-medium text-white ">
                How can I earn high yields on StableOx?
              </div>
              <div className="collapse-content text-customGray-main font-[400]">
                <p>
            ...
            <div className="collapse collapse-arrow bg-[#ffffff0d] rounded-[10px]">
              ...
              <div className="collapse-content text-customGray-main font-[400]">
                <p>
                  Yes, you can! If you gather enough support from the StableOx community, the protocol will automatically add the
